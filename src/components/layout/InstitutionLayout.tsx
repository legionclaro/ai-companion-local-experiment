...
export default function InstitutionLayout() {
    ...
    const getInitials = (email: string) => {
        return email ? email.charAt(0).toUpperCase() : "I";
    };
        ...
        `}
                    ...
                    <div className="h-16 flex items-center px-6 border-b border-border bg-primary/5">
                        <Link to="/" className="flex items-center gap-2">
                            ...
                            <span className="text-lg font-serif font-semibold text-foreground">
                                Bio<span className="text-primary">RD</span> Inst.
                            </span>
                        </Link>
                        <button
            ...
            <div className="flex-1 flex flex-col min-w-0">
                ...
                <header className="h-16 lg:hidden border-b border-border flex items-center px-4 bg-card">
                    ...
                    <span className="ml-3 font-semibold">Panel Instituional</span>
                </header>
